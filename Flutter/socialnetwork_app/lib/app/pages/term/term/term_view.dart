...
class TermTermView extends StatefulWidget {
  const TermTermView({super.key});

  @override
  State<TermTermView> createState() => _TermTermViewState();
}

class _TermTermViewState extends State<TermTermView> {
  @override
  Widget build(BuildContext context) {
    ...
    final highlights = AppTermsData.getGeneralHighlights(isEn);
    final allArticles = AppTermsData.getGeneralArticles(isEn);
  ...
  Widget _buildOverviewTab(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(
            isEn ? 'Key Highlights' : 'Điểm cốt lõi',
            style: TextStyle(
              fontSize: 16.sp,
              fontWeight: FontWeight.w500,
              color: cs.onSurface,
