...
class _GroupViewState extends State<GroupView> {
  ...
  void initState() {
    super.initState();
    controller = GroupController(groupId: widget.groupId);
  ...
  Widget _buildPostItem(Map<String, dynamic> post) {
    ...
    final currentUserId = controller.currentUser?['_id'] ?? '';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: () async {
            await controller.loadGroupDetails();
            await controller.loadGroupPosts();
          },
                  ...
                  Center(
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            if (controller.groupAvatar.isNotEmpty) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => AvatarFullScreen(imageUrl: controller.groupAvatar),
                                ),
                              );
                            }
                          },
                          child: CircleAvatar(
                            ...
                            backgroundImage: controller.groupAvatar.isNotEmpty
                                ? NetworkImage(controller.groupAvatar)
                                : null,
                        ...
                        if (controller.groupDescription.isNotEmpty) ...[
                          SizedBox(height: 4.h),
                          Text(
