              ...
              children: [
                      ...
                      label: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            size: 14.sp,
                            color: controller.privacy == 'friends' ? Colors.white : cs.onSurface,
                          ),
                          SizedBox(width: 4.w),
                          Text(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Text(
                        Language.of(context, 'add_to_your_post'),
                        style: TextStyle(
                          fontSize: 15.sp,
                          fontWeight: FontWeight.w500,
                          color: cs.onSurfaceVariant,
                      ...
                      IconButton(
                        ...
                        tooltip: Language.of(context, 'choose_photos_from_the_album'),
                      ),
                    ],
                  ),
                ),
