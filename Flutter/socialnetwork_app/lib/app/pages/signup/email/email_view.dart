                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  controller.toggleAgreedTerms();
                                },
                                child: Container(
                                  width: 23.r,
                                  height: 23.r,
                                  decoration: BoxDecoration(
                                    color: controller.isAgreedTerms ? Colors.blue : Colors.transparent,
                                    border: Border.all(
                                      color: controller.isAgreedTerms ? Colors.blue : cs.onSurface,
                                    ),
                                    borderRadius: BorderRadius.circular(8.r),
                                  ),
                                  child: controller.isAgreedTerms
                                      ? Icon(
                              ...
                              Expanded(
                                child: Wrap(
                                  ...
                                  children: [
                                    Text(
                                      Language.of(context, 'i_agree_to'),
                                      style: TextStyle(
                                        fontSize: 14.sp,
                                        color: cs.onSurface,
                                      ),
                          ...
                          Row(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  controller.toggleAgreedSocial();
                                },
                                child: Container(
                                  width: 23.r,
                                  height: 23.r,
                                  decoration: BoxDecoration(
                                    color: controller.isAgreedSocial ? Colors.blue : Colors.transparent,
                                    border: Border.all(
                                      color: controller.isAgreedSocial ? Colors.blue : cs.onSurface,
                                    ),
                                    borderRadius: BorderRadius.circular(8.r),
                                  ),
                                  child: controller.isAgreedSocial
                                      ? Icon(
                                          Icons.check_outlined,
                                          color: Colors.white,
                                          size: 16.r,
