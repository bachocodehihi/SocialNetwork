...
const sendOTP = (email, otp, type) => {
    return new Promise((resolve, reject) => {
        let subject = 'Account Verification';
        let title = 'Xác thực tài khoản';
        let greeting = 'Xin chào,';
        let description = 'Cảm ơn bạn đã lựa chọn tham gia mạng xã hội của chúng tôi. Dưới đây là mã xác thực tài khoản của bạn:';

        if (type === 'forgot') {
            subject = 'Reset Password Verification';
            title = 'Đặt lại mật khẩu';
            greeting = 'Chào bạn,';
            description = 'Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn. Dưới đây là mã xác thực để tiếp tục:';
        }
