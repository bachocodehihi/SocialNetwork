...
import { User as UserIcon, Loader2, MessageSquare, UserPlus, UserMinus, UserCheck, Search } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-grey/5 dark:bg-zinc-950 flex flex-col">
      ...
      <main className="pt-24 pb-12 px-4 max-w-4xl mx-auto w-full flex-grow">
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-grey/15 dark:border-zinc-800/80 p-6 sm:p-8 shadow-sm">
          {/* Header */}
