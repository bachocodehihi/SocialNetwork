      ...
      boxes.push(
        <div
          ...
          className={`w-12 h-14 md:w-14 md:h-16 flex items-center justify-center text-2xl font-bold rounded-xl border-2 transition-all duration-200 cursor-pointer ${
            char
              ? 'border-blue bg-blue/20 text-grey-hover dark:text-zinc-100 shadow-md'
              : isFocused
              ? 'border-blue bg-white dark:bg-zinc-800 ring-4 ring-blue/10 scale-105'
              : 'border-grey/20 dark:border-zinc-700 bg-grey/5 dark:bg-zinc-800/50 text-grey/60 dark:text-zinc-400 hover:border-gray-300 dark:hover:border-zinc-600'
          }`}
        >
          {char}
        </div>
    ...
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-200 dark:from-zinc-950 dark:to-zinc-900 p-4 font-sans'>
      <div className='w-full max-w-md bg-white dark:bg-zinc-900 rounded-[32px] shadow-sm p-8 border border-grey/20 dark:border-zinc-800'>
        ...
        <div className='text-center mb-8'>
          ...
          <h2 className='text-3xl font-extrabold text-grey-hover dark:text-zinc-100 tracking-tight'>
            Xác thực tài khoản
          </h2>
        ...
        <div className='mt-6 text-center text-xs'>
          <a href='/signup' className='text-grey hover:text-grey-hover dark:text-zinc-500 dark:hover:text-zinc-400 hover:underline transition-colors'>
